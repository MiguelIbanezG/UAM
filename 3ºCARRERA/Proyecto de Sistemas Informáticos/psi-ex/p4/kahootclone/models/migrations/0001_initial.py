# Generated by Django 3.2.1 on 2023-04-24 17:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True, null=True)),
                ('answerTime', models.IntegerField(blank=True, default=20)),
        ...
        migrations.CreateModel(
            name='Participant',
            fields=[
                ('id', models.AutoField(help_text='Unique ID for the Participant', primary_key=True, serialize=False)),
