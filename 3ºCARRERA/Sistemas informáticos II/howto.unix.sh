...
# curl: descargar una página web, invoca una API vía HTTP, ...
curl http://10.1.1.1:8080/P1/comienzapago -d "idTransaccion=1" -d "idComercio=1" -d "importe=1"
# wget: descargar una página web
wget http://10.1.1.1:8080/P1
