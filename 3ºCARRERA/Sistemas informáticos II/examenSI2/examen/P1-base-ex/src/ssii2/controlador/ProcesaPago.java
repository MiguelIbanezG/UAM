...
public class ProcesaPago extends ServletRaiz {
    ...
    public final static String PARAM_MONEDA = "moneda";
    ...
    */
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //Debería coger la sesion anterior pero no lo hace
        ...
        //fallo ej 1 (es probablemente la sesion)
    ...
    private PagoBean creaPago(HttpServletRequest request) {
        ...
        pago.setMoneda(request.getParameter(PARAM_MONEDA));
