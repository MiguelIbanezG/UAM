  ...
  if ((id_act = game_get_player_location(game)) != NO_ID)
  {
    ...
    if (id_back != NO_ID)
    {
      ...
      for (i = 0; i < 4; i++) 
      {
        ...
        if (game_get_object_location(game, objects[i]) == id_back && space_get_light(game_get_space(game, id_back)) == TRUE)
        {
    ...
    if (id_act != NO_ID)
    {
      for (i = 0; i < MAX_OBJ_SPCS; i++)
      {
        ...
        if (game_get_object_location(game, objects[i]) == id_act && space_get_light(game_get_space(game, id_act)) == TRUE)
        {
    ...
    if (id_next != NO_ID)
    {
      ...
      for (i = 0; i < 4; i++)
      {
        ...
        if (game_get_object_location(game, objects[i]) == id_next && space_get_light(game_get_space(game, id_next)) == TRUE)
        {
