...
int main(int argc, char** argv) {
  ...
  if (all || test == 14) test1_space_set_light();
  if (all || test == 15) test2_space_set_light();
  if (all || test == 16) test1_space_set_up();
  if (all || test == 17) test2_space_set_up();
  if (all || test == 18) test1_space_set_down();
  if (all || test == 19) test2_space_set_down();
  if (all || test == 20) test1_space_get_name();
  if (all || test == 21) test2_space_get_name();
  if (all || test == 22) test1_space_get_object();
  if (all || test == 23) test2_space_get_object();
  if (all || test == 24) test3_space_get_object();
  ...
  if (all || test == 35) test1_space_get_id();
  if (all || test == 36) test2_space_get_id();
  if (all || test == 37) test1_space_get_up();
  if (all || test == 38) test2_space_get_up();
  if (all || test == 39) test1_space_get_down();
  if (all || test == 40) test2_space_get_down();
...
void test1_space_set_north() {
  ...
  s = space_create(5);
  PRINT_TEST_RESULT(space_set_north(s, 5) == OK);
  space_destroy(s);
}
...
void test2_space_set_north() {
  ...
  PRINT_TEST_RESULT(space_set_north(s, 5) == ERROR);
}
...
void test1_space_set_south() {
  ...
  s = space_create(5);
  PRINT_TEST_RESULT(space_set_south(s, 5) == OK);
  space_destroy(s);
}
...
void test2_space_set_south() {
  ...
  PRINT_TEST_RESULT(space_set_south(s, 5) == ERROR);
}
...
void test1_space_set_east() {
  ...
  s = space_create(5);
  PRINT_TEST_RESULT(space_set_east(s, 5) == OK);
  space_destroy(s);
}
...
void test2_space_set_east() {
  ...
  PRINT_TEST_RESULT(space_set_east(s, 5) == ERROR);
}
...
void test2_space_set_west() {
  ...
  PRINT_TEST_RESULT(space_set_west(s, 5) == ERROR);
}
...
void test1_space_set_light(){
  ...
  s = space_create(5);
  PRINT_TEST_RESULT(space_set_light(s, 1) == OK);
  space_destroy(s);
}
...
void test2_space_set_light(){
  ...
  PRINT_TEST_RESULT(space_set_light(s, 0) == ERROR);
}
...
void test1_space_set_up() {
  ...
  PRINT_TEST_RESULT(space_set_up(s, 5) == OK);
...
void test2_space_set_up() {
  ...
  PRINT_TEST_RESULT(space_set_up(s, 5) == ERROR);
}
...
void test1_space_set_down() {
  ...
  s = space_create(5);
  PRINT_TEST_RESULT(space_set_down(s, 5) == OK);
  space_destroy(s);
}
...
void test2_space_set_down() {
  ...
  PRINT_TEST_RESULT(space_set_down(s, 5) == ERROR);
}
