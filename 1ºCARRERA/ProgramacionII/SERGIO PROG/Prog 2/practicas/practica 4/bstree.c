...
void *_bst_max(BSTNode *node, BSTree *tree)
{
    if (node == NULL) /*Si el nodo es nulo devuelve null*/
    {
        return NULL;
    ...
    return _bst_max(node->right, tree); /*Si el siguiente no es nulo, se llama otra vez a la función*/
}
...
void *tree_find_max(BSTree *tree)
{
    ...
    return _bst_max(tree->root, tree);
}
